...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8"><!--xác định kiểu mã hóa ký tự, tiếng việt- utf-8 -->
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1"><!--thiết kế khung hình để nhìn trên tất cả các thiết bị-->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Đăng nhập trang quản trị</h1>
                        </div>
                    </div>
                    <div class="row">
